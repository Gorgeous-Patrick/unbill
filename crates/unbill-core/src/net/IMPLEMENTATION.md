...
Protocol tests use in-process streams instead of real network endpoints. Coverage focuses on sync convergence, authorization behavior, and join success or failure.
